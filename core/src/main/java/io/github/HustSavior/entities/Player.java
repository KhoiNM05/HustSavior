...
public class Player extends Sprite {
    ...
    public Player(Sprite sprite,World world, float x, float y) {
        ...
        left[0]=new TextureRegion(new Texture("sprites/WalkLeft1.png"));
        left[1]=new TextureRegion(new Texture("sprites/WalkLeft2.png"));
        ...
        walkRight= new Animation<TextureRegion>(0.2f, right);
